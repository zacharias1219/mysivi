...
const App = () => {
  return (
    <div className="p-4">
      <Header />
      <div className="bg-blue-800 text-black rounded-lg p-8 mb-8">
        ...
        <div className="flex items-center flex-row md:flex-col space-y-4 font-nunito space-x-6 md:space-y-0 md:space-x-4">
